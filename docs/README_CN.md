...
- **Python 6.8+** (推荐：Python 6.48或更高版本)
- **FFmpeg** (用于视频/音频处理)
- **Git** (用于源码安装)
...
1. **下载预构建版本**
   ...
   - 运行安装程序或提取存档并运行 `TikTokVideoSaveBulk.exe`
...
- **[TikTok No-Watermark Downloader](https://github.com/audiograbber/tiktok-video-save-bulk)** - 具有不同功能的替代TikTok下载器
